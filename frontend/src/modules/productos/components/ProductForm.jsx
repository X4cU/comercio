      ...
      <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
        ...
        <div className="grid grid-cols-2 gap-3 md:grid-cols-3">
          {previews.map((img) => (
            <div
              key={img}
              className="relative w-20 h-20 overflow-hidden rounded-lg border border-gray-200 bg-gray-100 dark:border-gray-800 dark:bg-gray-800"
            >
              <img src={img} alt="Preview" className="w-full h-full object-cover object-center" />
              <button
                type="button"

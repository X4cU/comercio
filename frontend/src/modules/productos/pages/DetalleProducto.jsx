        ...
        <div className="card space-y-3">
          ...
          <div className="grid grid-cols-2 gap-3">
            {producto.imagenes?.map((img) => (
              <div
                key={img}
                className="w-20 h-20 rounded-lg overflow-hidden bg-gray-100 dark:bg-gray-800 border border-gray-200 dark:border-gray-800"
              >
                <img src={img} alt={producto.nombre} className="w-full h-full object-cover object-center" />
              </div>
            ))}
